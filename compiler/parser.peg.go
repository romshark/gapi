...
func (p *GAPIParser) Init(options ...func(*GAPIParser) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 38 KSB <- <('s' 'u' 'b' 's' 'c' 'r' 'i' 'p' 't' 'i' 'o' 'n')> */
		func() bool {
